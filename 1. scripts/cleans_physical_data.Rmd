...
tube_var <- c("depth", "U.mag", "U.heading",  "Temp.bot","U.heading", "Temp.bot", "Temp.mid", "Temp.top", "tr.fr.sib")  
...
## Context data
```{r}
one_variable <- c("Eta.avg", "airT", "precip", "PAR", "wind.mag", "wind.dir", "density", "tr.fr.sd")
...
test_count <- one_var_data %>% 
  group_by(id) %>% 
  tally()
## Each variable has 692 observations
